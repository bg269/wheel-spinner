...
const DESCRIPTION =
  'Spin the wheel to pick names, make decisions, and play yes or no wheel spinner games — free! ' +
  'The best classroom random name picker for teachers. ' +
  'No login, works on any device.';
